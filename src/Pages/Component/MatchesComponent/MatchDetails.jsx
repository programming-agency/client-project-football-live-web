...
export default function MatchDetails({ title }) {
    ...
    return (
        <Box>
            <Box>
                <BackButton title='France-Ligue 1' />
            </Box>
            <Box>
                <DetailsCard teamName1="liber Pull" teamName2="barsa" teamPhoto1="https://upload.wikimedia.org/wikipedia/commons/d/d6/Foolad_%28www_gravitysport_ir%29-800x800_%281%29.png" teamPhoto2="https://upload.wikimedia.org/wikipedia/commons/d/d6/Foolad_%28www_gravitysport_ir%29-800x800_%281%29.png" goal='0-0' />
            </Box>
